...
export default function UseCasesPage() {
  ...
  return (
    <div className="py-8 px-4 max-w-4xl mx-auto">
      ...
      <section className="mb-16">
        ...
        <div className="grid sm:grid-cols-2 gap-4">
          {AI_DESIGNER_KEYS.map(key => (
            ...
            >
              <h4 className={`${ui.text.strong} group-hover:text-blue-600 dark:group-hover:text-blue-400 ${ui.transition.default} mb-1`}>
      ...
      {/* CTA */}
      <section className={`text-center py-12 bg-theme-bg-secondary rounded-2xl border ${ui.border.default}`}>
        <h2 className={`${ui.text.h2} mb-4`}>
